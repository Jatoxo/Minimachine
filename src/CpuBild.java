...
class CpuBild extends JComponent {
	...
	protected void paintComponent(Graphics var1) {
		...
		var1.drawString("Datenbus", 15, this.höheKasten);
		...
		if (!this.mikroschritt.equals("")) {
			var1.drawString("Mikroschritt: " + this.mikroschritt, 200, (this.höheKasten + var3 / 2 - this.höheCpu / 2) / 2 + 10);
		}
		...
		var1.drawString("Adressbus", 15, var3 - 40);
		...
		var1.drawString("Akkumulator", 25, var3 / 2 - this.höheCpu / 2 + this.höheKasten);
		var1.drawString("Status", 25, var3 / 2 + this.höheCpu / 2 - (this.höheKasten + 20));
		var1.drawString("Befehlsregister", this.breiteCpu - 2 * this.breiteKasten + 5, var3 / 2 - this.höheCpu / 2 + this.höheKasten);
		var1.drawString("Programmzähler", this.breiteCpu - 2 * this.breiteKasten + 5, var3 / 2 - this.höheCpu / 2 + 3 * this.höheKasten + 20);
		if (this.erweitert) {
			var1.drawString("Stackpointer", this.breiteCpu - 2 * this.breiteKasten + 5, var3 / 2 - this.höheCpu / 2 + 5 * this.höheKasten + 40);
		}
